...
export default function Home() {
  return (
    <>
      ...
      <main>
        <Hero />
        <section className="border-y border-asphalt/10 bg-background py-14 sm:py-20">
          <div className="mx-auto grid max-w-6xl gap-10 px-5 sm:px-8 lg:grid-cols-2">
            <div>
              ...
              <Link
                href="/live"
                className="mt-6 inline-block rounded-sm bg-asphalt px-5 py-3 text-sm font-semibold tracking-wide text-white uppercase transition hover:bg-road"
              >
                Open live activity
              </Link>
            </div>
            <div>
              ...
              <Link
                href="/plan"
                className="mt-6 inline-block rounded-sm bg-amber px-5 py-3 text-sm font-semibold tracking-wide text-asphalt uppercase transition hover:bg-amber-hot"
              >
                Plan a route
              </Link>
            </div>
